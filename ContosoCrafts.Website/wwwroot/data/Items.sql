INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
...
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        ...
        'https://www.hackster.io/agent-hawking-1/create-a-compact-survival-kit-38bfdb', 
...
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        ...
        'https://twitter.com/sailorhg/status/1090107740049952770', 
        'Bubblesort Visualization', 
        'Visualization of sailor scouts sorted by bubblesort algorithm by their planets distance from the sun', 
        '2', 
        'sailorhg-bubblesortpic');
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        'https://user-images.githubusercontent.com/41929050/61567055-142c1c80-aa33-11e9-96ff-9fbac6413625.png', 
        'https://twitter.com/sailorhg/status/1090113666911891456', 
        'Light-up Corsage', 
        'Light-up corsage I made with my summer intern.', 
        '2', 
        'sailorhg-corsage');
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        'https://user-images.githubusercontent.com/41929050/61567056-142c1c80-aa33-11e9-8682-10065d338145.png', 
        'https://twitter.com/sailorhg/status/1090122822007963648', 
        'Pastel hardware kit', 
...
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        ...
        'https://twitter.com/sailorhg/status/1090117277540745216', 
        'Heart-shaped LED', 
        'custom molded heart shaped LED with sprinkles.', 
        '2', 
        'sailorhg-led');
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        'https://user-images.githubusercontent.com/41929050/61567060-142c1c80-aa33-11e9-8188-5a4803844a9e.png', 
        'https://www.instagram.com/p/BNvESj-j8PI/', 
        'Black Sweatshirt', 
...
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        ...
        'https://www.instagram.com/p/BNm6hZzDoEF/', 
...
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        ...
        'https://www.vogueandcode.com/shop/hipster-dev-bro', 
        'Hipster Dev', 
...
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        ...
        'https://www.vogueandcode.com/shop/ruby-sis-2', 
        'Ruby Sis', 
...
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        ...
        'https://www.instagram.com/p/BFktVYPinKQ/', 
        'Holographic Dark Moon Necklace', 
        'Not sure if Ill be making more, get it while I have it in the store.', 
        '3', 
        'selinazawacki-moon');
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        'https://user-images.githubusercontent.com/41929050/61567058-142c1c80-aa33-11e9-89fb-b4f30d84d69d.png', 
        'https://www.instagram.com/p/BEXlpiZCnJ3', 
        'Floppy Crop', 
...
INSERT INTO Items (ImageUrl,ItemUrl,Title,Description,MakerId,ItemShortName) 
    VALUES (
        'https://user-images.githubusercontent.com/41929050/61567058-142c1c80-aa33-11e9-89fb-b4f30d84d69d.png', 
        'https://www.instagram.com/BEXlpiZCnJ3', 
        'Floppy Crop', 
        'Used up the Diskette fabric today to make 2 of these crops.', 
        '3', 
        'selinazawacki-shirt');
